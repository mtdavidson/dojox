...
define(["dojo", "dijit", "dojox", "dojo/string", "dojo/fx", "dijit/_Widget", "dijit/_Templated"], function (dojo, dijit, dojox, string, fx, _Widget, _Templated) {
    dojo.declare("dojox.image.SlideShow", [dijit._Widget, dijit._Templated], {
        ...
        _overElement: function ( /*DomNode*/ element, /*Event*/ e) {
            ...
            return (m.x >= bb.x && m.x <= (bb.x + bb.w) && m.y >= bb.y && m.y <= (top + bb.h)); //	boolean
        }
    });
});
